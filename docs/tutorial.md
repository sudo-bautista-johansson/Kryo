...
```bash
# Compile and run
kryo run program.kyo

# Output: 30
```

### Hello World with Formatted Output
...
Kryo provides several built-in functions for common tasks:
...
fn collections_example() -> i32 {
    ...
    // Create bounded vector with capacity
